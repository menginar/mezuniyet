		...
		<div id="content" class="span10">
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="{{ URL::to('admin/confirm_waiting_humours') }}">Onay Bekleyen Mizahlar</a> 
					</li>
				</ul>
			</div>
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
							...
							<tr>
								...
								<td class="center">
									<a class="btn btn-success btn-round" href="{{ URL::route('humour_confirm', array('id' => $humour->id)) }}">
										<i class="icon-ok icon-white"></i> 
										Kabul
									</a>
									<a class="btn btn-danger btn-round" href="{{ URL::route('humour_ignore', array('id' => $humour->id)) }}"
