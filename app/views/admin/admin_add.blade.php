		...
		<div id="content" class="span10">
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="{{ URL::to('admin/admin_add') }}">Yönetici Ekle</a>
					</li>
				</ul>
			</div>
				...
				<div class="row-fluid sortable">
					<div class="box span12">
						<div class="box-header well" data-original-title>
							<h2><i class="icon icon-add"></i> Yönetici Ekle</h2>
							<div class="box-icon">
						...
						<div class="box-content">
							{{ Form::open(array('url'=>'admin/admin_add', 'class'=>'form-signup')) }}
							...
							{{ Form::submit('Yönetici Ekle', array('class'=>'btn btn-primary btn-block'))}}
						{{ Form::close() }}
						</div>
					</center>
				</div><!--/span-->
