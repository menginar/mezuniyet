						...
						{{ Form::open(array('url'=>'admin/userupdate', 'method' => 'post', 'class'=>'form-horizontal')) }}
						  <fieldset>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								{{ Form::text('email', $uye->email, array('class'=>'form-control input-xlarge')) }}
							  </div>
							</div>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								{{ Form::text('first_name', $uye->first_name, array('class'=>'form-control input-xlarge')) }}
							  </div>
							</div>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								{{ Form::text('last_name', $uye->last_name, array('class'=>'form-control input-xlarge')) }}
							  </div>
							</div>
							...
							<label class="control-label" for="date01">Telefon Numara</label>
							  <div class="controls">
								{{ Form::text('phone_number', $uye->phone_number, array('class'=>'form-control input-xlarge')) }}
							  </div>
							</div>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								{{ Form::text('birthday', $uye->birthday, array('class'=>'form-control input-xlarge datepicker')) }}
							  </div>
							</div>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
							  	<select name="gender" class="form-control" style="width:2.92in;">
									<option value="{{ $uye->gender }}"></option>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								{{ Form::text('faculty_name', $uye->faculty_name, array('class'=>'form-control input-xlarge')) }}
							  </div>
							</div>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								{{ Form::text('department_name', $uye->department_name, array('class'=>'form-control input-xlarge')) }}
							  </div>
							</div>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								{{ Form::text('student_number', $uye->student_number, array('class'=>'form-control input-xlarge')) }}
							  </div>
							</div>
						  ...
						  <tbody>
							...
							<tr>
								...
								<td class="center">
									...
									<a class="btn btn-danger btn-round" href="{{ URL::route('comment_ignore', array('id' => $yorum->id)) }}"
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
							...
							<tr>
								...
								<td class="center">
									<a class="btn btn-danger" href="{{ URL::route('image_ignore', array('id' => $foto->id)) }}"
																	onclick="return confirm('Silmek İstediğinize Emin misiniz?')">
										<i class="icon-trash icon-white"></i> 
										Sil
									</a>
