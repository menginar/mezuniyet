		...
		<div id="content" class="span10">
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="{{ URL::to('admin/admins') }}">Yöneticiler</a> 
					</li>
				</ul>
			</div>
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-user"></i> Yöneticiler</h2>
						<div class="box-icon">
						  ...
						  <tbody>
							...
							<tr>
								...
								<td class="center">
									...
									<a class="btn btn-danger btn-round" href="{{ URL::route('admin_ignore', array('id' => $admin->id)) }}"
