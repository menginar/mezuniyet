		...
		<div id="content" class="span10">
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="{{ URL::to('admin/humours') }}">Paylaşılan Mizahlar</a> 
					</li>
				</ul>
			</div>
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
							...
							<tr>
								...
								@endif
								<td class="center">
									<a class="btn btn-danger btn-round" href="{{ URL::route('humours_ignore', array('id' => $humour->id)) }}"
